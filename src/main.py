...
if __name__ == "__main__":
    ...
    tile_scraper = TileScraper(headless=HEADLESS, output_dir=OUTPUT_DIR, aoi_shp_path=AOI_SHP_PATH)
    ...
    tile_scraper.download_desired_data_gov_uk_product(desired_product_list=DESIRED_PRODUCT_LIST, desired_year=DESIRED_YEAR, latest=LATEST)
